...
public class Conversor extends JFrame implements KeyListener, ItemListener {
    ...
    private JComboBox<Integer> cbBaseA;
    private JComboBox<Integer> cbBaseB;
    ...
    public Conversor() {
        super("JConversorSN | Daniel Alvarez | www.danyalvarez.com");
        configurarVentana();
